    ...
    if attempts == 0 do
      ...
      if card1 == card2 do
        ...
        if pairs_count == 0 do
          ...
          IO.puts("Pares encontrados: #{new_found_pairs}")
        else
          loop(board, attempts, pairs_count, new_found_pairs, new_revealed)
        end
      else
        IO.puts("No es un par. Intentalo nuevamente.")
        loop(board, attempts - 1, pairs_count, found_pairs, revealed)
      end
    end
  end
